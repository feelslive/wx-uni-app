...
/* 0 */
/*!**************************************************************!*\
  !*** /Users/wangfukang/Desktop/demos/baojie-uni-app/main.js ***!
  \**************************************************************/
...
__webpack_require__(/*! ./iconfont.css */ 14);
var _index = _interopRequireDefault(__webpack_require__(/*! ./store/index.js */ 15));
var _theme = __webpack_require__(/*! ./theme/theme.js */ 10);



var _BASE_URL = __webpack_require__(/*! ./BASE_URL.js */ 18);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}

_vue.default.config.productionTip = false;
var ENV = 'dev'; // 开发环境：dev；正式环境：prod
uni.setStorageSync('env', _BASE_URL.URL[ENV]);
_vue.default.prototype.$setTabBar = function (index) {
  if (typeof this.$mp.page.getTabBar === 'function' && this.$mp.page.getTabBar()) {
    var theme = uni.getStorageSync("theme");
    this.$mp.page.getTabBar().setData({
      selected: index,
      selectedColor: _theme.COLOR[theme],
      list: [{
        pagePath: '/pages/index/index',
        iconPath: './static/tab_home.png',
        selectedIconPath: _theme.ICON[theme].home,
        text: '首页' },

      {
        pagePath: '/pages/serve/serve',
        iconPath: './static/tab_order.png',
        selectedIconPath: _theme.ICON[theme].order,
        text: '服务' },

      {
        pagePath: '/pages/mine/mine',
        iconPath: './static/tab_member.png',
        selectedIconPath: _theme.ICON[theme].member,
        text: '我的' }] });
...
/* 5 */
/*!**************************************************************!*\
  !*** /Users/wangfukang/Desktop/demos/baojie-uni-app/App.vue ***!
  \**************************************************************/
/*! no static exports found */
...
component.options.__file = "Users/wangfukang/Desktop/demos/baojie-uni-app/App.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),
/* 6 */
/*!***************************************************************************************!*\
  !*** /Users/wangfukang/Desktop/demos/baojie-uni-app/App.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 7 */
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/wangfukang/Desktop/demos/baojie-uni-app/App.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _baseInfo = __webpack_require__(/*! ./interface/baseInfo.js */ 8);
var _theme = __webpack_require__(/*! ./theme/theme.js */ 10);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  data: function data() {
    return {
      systemInfo: null,
  ...
  onLaunch: function onLaunch() {var _this = this;
    ...
    wx.getSystemInfo({
      success: function success(res) {
        ...
        var iphoneX = /iphone x/i.test(res.model);
        var iphoneNew = /iPhone11/i.test(res.model) && res.screenHeight === 812;
        _this.isIPhoneX = iphoneX || iphoneNew;
        console.log('this.isIPhoneX', _this.isIPhoneX);
        uni.setStorageSync('iphoneX', _this.isIPhoneX);
      } });
  ...
  methods: {
    getBaseData: function getBaseData() {var _this2 = this;
      return new Promise(function (resolve, reject) {
        (0, _baseInfo.getBaseInfo)().
        then(function (res) {
          uni.setStorageSync('store_id', res.data.store_id);
          uni.setStorageSync('theme', res.data.theme);
          _this2.$store.dispatch('setAppInfo', res.data);
          _this2.$store.dispatch('setColor', _theme.COLOR[res.data.theme]);
          resolve();
        }).
        catch(function (err) {
          uni.showModal({
...
/* 11 */
/*!************************************************************************************************!*\
  !*** /Users/wangfukang/Desktop/demos/baojie-uni-app/App.vue?vue&type=style&index=0&lang=scss& ***!
  \************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 12 */
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/wangfukang/Desktop/demos/baojie-uni-app/App.vue?vue&type=style&index=0&lang=scss& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
